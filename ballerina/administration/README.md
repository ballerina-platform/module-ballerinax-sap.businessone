...
The SAP Business One Administration & Setup connector provides APIs for the administration and setup objects of SAP Business One: users, user groups, approval procedures, alerts, queries, countries, currencies, and Web Client settings, exposed through the [SAP Business One Service Layer](https://help.sap.com/docs/SAP_BUSINESS_ONE_ONE_BRANCH) (OData).
