...
The SAP Business One Human Resources connector provides APIs for the human resources objects of SAP Business One: employee master data, teams, and HR setup, exposed through the [SAP Business One Service Layer](https://help.sap.com/docs/SAP_BUSINESS_ONE_ONE_BRANCH) (OData).
...
humanresources:Client b1Client = check new (
