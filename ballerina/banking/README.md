...
The SAP Business One Banking & Payments connector provides APIs for the banking objects of SAP Business One: incoming and outgoing payments, deposits, checks, bank statements, and reconciliations, exposed through the [SAP Business One Service Layer](https://help.sap.com/docs/SAP_BUSINESS_ONE_ONE_BRANCH) (OData).
...
banking:Client b1Client = check new (
