...
The SAP Business One Purchasing (A/P) connector provides APIs for the purchasing (A/P) documents of SAP Business One: purchase requests, quotations, orders, goods receipts, returns, invoices, and landed costs, exposed through the [SAP Business One Service Layer](https://help.sap.com/docs/SAP_BUSINESS_ONE_ONE_BRANCH) (OData).
