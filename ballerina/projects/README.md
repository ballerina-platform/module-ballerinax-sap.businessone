...
The SAP Business One Project Management connector provides APIs for the project management objects of SAP Business One: projects, project management entities, and time sheets, exposed through the [SAP Business One Service Layer](https://help.sap.com/docs/SAP_BUSINESS_ONE_ONE_BRANCH) (OData).
