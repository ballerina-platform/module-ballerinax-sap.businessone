...
The SAP Business One Financials connector provides APIs for the financial accounting objects of SAP Business One: chart of accounts, journal entries, budgets, cost accounting dimensions, and tax setup, exposed through the [SAP Business One Service Layer](https://help.sap.com/docs/SAP_BUSINESS_ONE_ONE_BRANCH) (OData).
